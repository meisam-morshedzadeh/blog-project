                ...
                <section class="table-responsive">
                    <table class="table table-striped table-">
                        ...
                        <tbody>
                            <?php
                                global $pdo;
                                $query ="SELECT blog_project.posts.*,blog_project.categories.name AS cat_name FROM blog_project.posts LEFT JOIN blog_project.categories ON blog_project.posts.cat_id=blog_project.categories.id";
